...
import { type EmpireData, pickRandomEmpire } from '../../../random/empires.ts'
import checkUprisingAlarm from './check.ts'
import drawIsland from '../../../random/island.ts'
...
const generateUprising = async (
  ...
  const situation = selectRandomElement(getSituations())
